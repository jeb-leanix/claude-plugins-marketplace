...
export class Notifier {
     ...
     */
    sendDesktopNotification(event, prNumber) {
        try {
     ...
     */
    notifySummary(summary, prNumber) {
        if (this.options.desktop) {
            try {
     ...
     */
    notifyError(title, message, prNumber) {
